...
\newcommand{\eat}[1]{}
\input{speakql-commands}
\input{snails-commands}
\input{skalpel-commands}
...
and to the memory of my good friend \emph{Ethan Clark}, whose passion prompted my first steps toward a lifetime of exploration in the field of computing. No matter how hard I study, I will never reach the level of skill that Ethan always demonstrated so effortlessly.
\end{dedication}
% Optional
\begin{epigraph}
\vskip0pt plus.5fil
...
\bibliography{speakql-ref, snails-ref, skalpel-ref}
