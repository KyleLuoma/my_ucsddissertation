...
\begin{figure*}[t]
  ...
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[height=1.3in]{figures/Total-Time-first-half-boxplot.pdf}
    \caption{First half - Total Time, All Attempts, By Individual Query}
    \label{fig:querytotaltimefirsthalf}
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[height=1.3in]{figures/First-Attempt-Planning-Time-first-half-boxplot.pdf}
    \caption{First half - Planning Time, First Attempts, By Individual Query}
    \label{fig:queryplanningtimefirsthalf}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/query-attemptnum-firsthalf-histplot-excel.png}
    \caption{First half - Number of Attempts By Individual Query}
    \label{fig:queryattemptnumfirsthalf}
  \end{subfigure}
  \caption{Quantitative results from the first dialect as an approximation of a between-subjects design.}
  \label{fig:quant_firsthalf}
\end{figure*}
}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figures/error-type-counts.png}
